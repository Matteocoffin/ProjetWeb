...
class AdminOffreController extends AbstractController
{
    ...
    public function index(PaginatorInterface $paginator,Request $request, Request $requestCompetence, Request $requestSearch) 
    {
        ...
        dump($offre);
        return $this->render("admin/GestionOffre.html.twig", ['offre' => $offre, 'formCompetence'=> $formCompetence->createView(), 'form'=> $form->createView(), 'formSearch' => $formSearch->createView()]);
    }
    ...
    public function edit(Offre $offre,Competences $Competence, Request $request, Request $requestCompetence)
    {
       ...
       return $this->render('admin/ModifierOffre.html.twig', ['offre' => $offre, 'form' => $form->createView(),'formCompetence'=> $formCompetence->createView()]);
    }
    /**
