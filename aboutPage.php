...
<html>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="image/1er.jpg" class="d-block w-100" alt="...">
            ...
            <div class="carousel-item">
                <img src="image/2eme.png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="image/join-us.png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
    ...
    <div class='container' style='margin-top: 5%; background-color:lightgray;'>
    ...
    <div class="card w-75" style='margin-top: 5%; margin-left: 10%;'>
        <div class="card-body">
            <h5 class="d-flex justify-content-center">Site pratique et sécurisé</h5>
            <p class="card-text" style='margin-top: 5%;'>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</p>
        </div>
    </div>
